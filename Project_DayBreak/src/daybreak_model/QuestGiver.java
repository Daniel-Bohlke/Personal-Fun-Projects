...
public class QuestGiver extends NPC{
	...
	public QuestGiver(String message, Item questItem, int x, int y, Handler handler, SpriteSheet ss){
	...
	public QuestGiver(int lvl, String message, Item questItem, int x, int y, Handler handler, SpriteSheet ss){
