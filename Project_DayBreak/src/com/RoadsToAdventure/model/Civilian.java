...
public class Civilian extends NPC{
	...
	public Civilian(int x, int y, Handler handler, SpriteSheet ss) {super(x, y, handler, ss);}

	public Civilian(int lvl, int x, int y, Handler handler, SpriteSheet ss){
		super(lvl, y, x, handler, ss);
	}
